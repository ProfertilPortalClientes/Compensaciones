		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#profertilcompensacionesv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"profertilcompensacionesv2-display": {
								"semanticObject": "profertilcompensacionesv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=profertil.compensacionesv2",
									"url": sap.ui.require.toUrl("profertil/compensacionesv2")
								}
							}
						}
					}
